...
source_path = "C:\\SendFolder\\"
archive_path = "C:\\SendFolder\\Archive\\"
 
#logging configuration
logging.basicConfig(filename="C:\\SendFolder\\Logs\\info.log", level=logging.INFO)
...
if file_list != []:
    ...
    app_module.mail_send(final_attachment)
